...
{
    public string EnvBase { get; set; }
    public string WorkerName { get; set; }

    private List<string> userAgentPool = new List<string>();

    public WebCrawlerWorker(string envBase, string workerName, int Delay)
    {
        EnvBase = envBase;
        WorkerName = workerName;
        userAgentPool .addrange
        {
